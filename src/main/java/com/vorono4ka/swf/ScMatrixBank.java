...
public class ScMatrixBank {
    ...
    public List<ColorTransform> getColorTransforms() {
        return Collections.unmodifiableList(this.colorTransforms);
    }
    ...
    public void setColorTransform(int index, ColorTransform color) {
        this.colorTransforms.set(index, color);
    }
