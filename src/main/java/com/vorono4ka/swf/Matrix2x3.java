...
public class Matrix2x3 implements Savable {
    ...
    public boolean equals(Object o) {
        ...
        Matrix2x3 a = getRounded();
        Matrix2x3 b = matrix2x3.getRounded();
        return a.a == b.a && a.b == b.b && a.c == b.c && a.d == b.d && a.x == b.x && a.y == b.y;
    }

    @Override
    public int hashCode() {
        Matrix2x3 a = getRounded();
        return Objects.hash(a.a, a.b, a.c, a.d, a.x, a.y);
    }
    ...
    public Matrix2x3 getRounded() {
        return new Matrix2x3(Math.round(a*100*2) / (100*2f), Math.round(b * 100 * 2) / (100*2f), Math.round(c*100*2) / (100*2f), Math.round(d*100*2) / (100*2f), Math.round(x*2.5f*2) / (2.5f*2), Math.round(y*2.5f*2) / (2.5f*2));
    }
